...
class Direcao():
    direcao_possivel = ('Norte', 'Leste', 'Sul', 'Oeste')

    def __init__(self):
        self.indice_direcao = 0
        self.valor = self.direcao_possivel[self.indice_direcao]

    def girar_a_direita(self):
        self.indice_direcao += 1
        self.indice_direcao = self.indice_direcao % len(self.direcao_possivel)
